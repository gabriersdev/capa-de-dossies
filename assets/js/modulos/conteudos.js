...
<section class="header-principal">
  <div>
    ...
    <button class="btn btn-secondary none" data-action="enviar-para-ateste" data-toggle="tooltip" data-placement="bottom" title="Enviar para Ateste" disabled><i class="bi bi-journal-medical"></i></button>
